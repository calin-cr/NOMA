...
%   comm.RectangularQAMModulator, comm.PSKDemodulator,
%   comm.QPSKDemodulator, comm.RectangularQAMDemodulator.
%
...
switch name
    ...
    case {"16qam", "16"}
        ...
        cfg.ModulatorFactory = @()comm.RectangularQAMModulator( ...
            'ModulationOrder', order, ...
            'BitInput', true, ...
            'NormalizationMethod', 'Average power');
        cfg.DemodulatorFactory = @()comm.RectangularQAMDemodulator( ...
            'ModulationOrder', order, ...
            'BitOutput', true, ...
            'NormalizationMethod', 'Average power');
    case {"64qam", "64"}
